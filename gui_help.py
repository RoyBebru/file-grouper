...
<table width="100%">
  <tr>
    ...
    <td width="75%">
      ...
      <p>Додаток намагається запусти графічний діалог для
      ...
      оцінки результату можна прийняти зважене остаточне рішення. У Windows для створення посилань
      подтрібні додаткові права. В режимі Андміністратора додаток працюватиме як очікується.</p>
      <a name="#desc-cli"></a>
